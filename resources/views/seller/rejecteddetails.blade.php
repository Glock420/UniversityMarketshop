        ...
        <div class="flex-container">
            <div class="detailsBox">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="prod_name" name="prod_name" value="{{ $product->prod_name }}" readonly disabled>
                </div>
                <div class="form-group">
                    <label for="category" style="font-weight: bold">Category</label>
                    <select class="form-control" id="category" name="category" readonly disabled>
                        <option value="{{ $product->category }}" selected>{{ $product->category }}</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="description" style="font-weight: bold">Description</label>
                    <textarea class="form-control" id="description" name="description" rows="6" readonly disabled>{{ $product->description }}</textarea>
                </div>
                <div class="form-group">
                    <label for="price" style="font-weight: bold">Price</label>
                    <input type="number" step="0.50" class="form-control" id="price" name="price" value="{{ $product->price }}" readonly disabled>
                </div>
                <div class="form-group">
                    @if($variationexist)
                        <h5 style="font-weight: bold">Variations</h5>
                ...
                <div class="form-group">
                    <label for="reject_reason" style="font-weight: bold">Reason for Rejection</label>
                ...
                <div class="mt-4 d-flex justify-content-between">
                    <a href="{{ route('rejectedproduct') }}" class="btn btn-dark">Back</a>
                </div>
            </div>
            <div class="ppBox">
