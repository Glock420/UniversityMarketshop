                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{ url('/admin/categorylist/editcategory/'.$category->cat_id) }}" class="editDel">Edit</a>|<a href="{{ url('/admin/categorylist/deletecategory/'.$category->cat_id) }}" class="editDel">Delete</a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
...
<script>
    ...
    function filterUsers() {
        ...
        userRows.forEach(row => {
            ...
            if (nameOrg.includes(searchTerm))
            {
