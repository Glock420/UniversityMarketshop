...
<div class="edit">
    <form action="{{ route('reject.product') }}" method="POST">
        ...
        <div class="row mt-4">
            <div class="col-md-6">
                @csrf
                <h5>Add Reason for Rejection <br><br></h5>
                <input type="hidden" name="prod_id" value="{{ $product->prod_id }}">
                <div class="form-group reason">
                    <textarea class="form-control" id="reject_reason" name="reject_reason" rows="6" required></textarea>
                    <span class="text-danger">@error('reject_reason') {{$message}} @enderror</span>
                </div>
                <div class="form-group reason mb-3">
    ...
    <div>
        <a href="{{ route('productlist') }}" class="btn btn-secondary" style="width: 10%">Back</a>
    </div>
