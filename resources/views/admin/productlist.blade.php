...
<section class="secBody">
        ...
        <section class="table_body">
            ...
            <!--table body-->
                ...
                <tr>
                    ...
                    <td><a href="{{ url('/admin/productlist/productdetails/'.$product->prod_id) }}" class="view"><b>View Details</b></a></td>
                </tr>
                @endforeach
                </tbody>
            </table>
    ...
    <div>
        <a href="{{ route('rejectedlist') }}" class="btn btn-danger">Rejected Products</a>
    </div>
</section>
